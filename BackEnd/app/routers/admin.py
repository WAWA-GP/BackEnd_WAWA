...
def create_notice(
    ...
    return success_response("공지사항이 생성되었습니다.", data=new_notice)
...
def list_notices(
    ...
    notices = query.order_by(Notice.id.desc()).offset(offset).limit(limit).all()
    return success_response("공지사항 목록 조회 성공", data=notices)
...
def get_notice(
    ...
    if not notice:
        raise http_error(404, "공지사항을 찾을 수 없습니다.")
    return success_response("공지사항 조회 성공", data=notice)
...
def update_notice(
    ...
    db.commit()
    return success_response("공지사항이 수정되었습니다.")
...
def delete_notice(
    ...
    db.delete(notice)
    db.commit()
    return success_response("공지사항이 삭제되었습니다.")
...
def create_faq(
    ...
    db.commit()
    db.refresh(new_faq)
    return success_response("FAQ가 생성되었습니다.", data=new_faq)
...
def list_faqs(
    ...
    faqs = query.order_by(FAQ.id.desc()).offset(offset).limit(limit).all()
    return success_response("FAQ 목록 조회 성공", data=faqs)
...
def get_faq(
    ...
    if not faq:
        raise http_error(404, "FAQ를 찾을 수 없습니다.")
    return success_response("FAQ 조회 성공", data=faq)
...
def update_faq(
    ...
    db.commit()
    return success_response("FAQ가 수정되었습니다.")
...
def delete_faq(
    ...
    db.delete(faq)
    db.commit()
    return success_response("FAQ가 삭제되었습니다.")